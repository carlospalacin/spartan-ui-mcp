...
### Length Limits (from commitlint.config.js)
| Rule | Limit | What it covers |
|------|-------|----------------|
| `header-max-length` | **100 chars** | Entire first line: `type(scope): subject` |
| `body-max-line-length` | **100 chars** | Each line in the body |

CRITICAL: The header is the ENTIRE first line including type, scope, colon, and subject.
With a long scope like `resource-planning/allocation`, the subject has fewer available characters.
Always count the full header length.

### Subject Rules
1. ✅ Use imperative mood: "add" NOT "added" or "adds"
2. ✅ Lowercase first letter
3. ✅ No period at the end
4. ✅ Keep header under 100 characters total
...
3. Wrap at 100 characters per line (matches `body-max-line-length`)
